...
import {changeDetail, save} from 'store/modules/returnEdit';
...
@withRouter
@connect(state => ({
  isLoading: state.returnEdit.isLoading,
  detail: state.returnEdit.detail,
  hasMore: state.returnEdit.hasMore
}), {
  changeDetail,
  save
})
class ReturnEdit extends Component {
  static propTypes = {
